...
- 1170 deterministic tests cover phases 0 to 25, the Phase 26A import pipeline, Phase 26B import review UI, Phase 26C post-import review integration, Phase 26D edge-case hardening, Phase 26E Obsidian-compatible import, Phase 26F end-to-end import lifecycle finalisation, Phase 29A documentation guardrails, Phase 29B navigation and information architecture guardrails, Phase 29C design system foundation guardrails, Phase 29D page-level UX consistency guardrails, Phase 29E final polish and release-readiness guardrails, Phase 30B app-shell / theme / primitive foundation guardrails, Phase 30C Dashboard redesign guardrails, Phase 30D1 Validation, Tasks, and Raw Developer real-implementation guardrails, Phase 30D2 Notes and Graph workspace redesign guardrails, Phase 30D3 Security and Imports redesign guardrails, Phase 30E1 Pending/Trust/Feedback governance polish guardrails, Phase 30F final QA, light-mode toggle, accessibility, and responsive guardrails (source-level only; browser visual and screen-reader QA remain manual), Phase 31A release-candidate verification checklist guardrails, Phase 31B header/toolbar normalisation guardrails, Phase 31C release-candidate visual QA and defect-triage documentation-honesty guardrails (source-level only; the agent that executed Phase 31C did not open a browser, did not perform live keyboard traversal, and did not run a screen reader, so the manual rows in `RELEASE_CHECKLIST.md` remain manual), iterative UI polish pass source guardrails (Batches A-E; no runtime changes), plus documentation drift guardrails.
...
- [ROADMAP.md](ROADMAP.md) - completed, planned, and deferred phases
